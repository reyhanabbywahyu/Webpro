  ...
  <div class="container">
    ...
    <img src="https://sangkuriang.co.id/wp-content/uploads/2019/07/logo-sangkuraing-landscape.png" alt="logo" width="50%;"></a></div>
        <div class="col-6 col-6-md-4">
            ...
            <a class="nav-link dropdown-toggle" href="about_us" id="navbardrop" data-toggle="dropdown">ABOUT US</a>
...
<div class="container container-fluid">
  <div class="row">
    ...
    <h1 class="judul">Services<h1>
      <div class="text">
      <h6>We have full-fledged IT solution services. Our top 6 services are: Big Data & Intelligence, Information System, IT Planning, IT Procurement, Web Portal, and Data Center.</h6>
      </div>
    </div>
    <div class="col-md">
      <form class="d-flex">
